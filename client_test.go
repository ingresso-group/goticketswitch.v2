...
func TestGetAvailability(t *testing.T) {
	...
	if assert.Nil(t, err) {
		...
		assert.Equal(t, results.Availability.TicketTypes[0].PriceBands[0].PossibleDiscounts.Discounts[0].Code, "ADULT")
		assert.Equal(t, results.Availability.TicketTypes[0].PriceBands[0].PossibleDiscounts.Discounts[0].MinAge, 18)
		assert.Equal(t, results.Availability.TicketTypes[0].PriceBands[0].PossibleDiscounts.Discounts[0].MaxAge, 0)
		assert.Equal(t, results.Availability.TicketTypes[0].PriceBands[0].PossibleDiscounts.Discounts[1].Code, "CHILD")
		assert.Equal(t, results.Availability.TicketTypes[0].PriceBands[0].PossibleDiscounts.Discounts[1].MinAge, 0)
		assert.Equal(t, results.Availability.TicketTypes[0].PriceBands[0].PossibleDiscounts.Discounts[1].MaxAge, 17)
...
func TestGetDiscounts(t *testing.T) {
	...
	if assert.Nil(t, err) {
		...
		assert.Equal(t, discounts[0].MinAge, 18)
		assert.Equal(t, discounts[0].MaxAge, 64)
		assert.Equal(t, discounts[1].Code, "CHILD")
		assert.Equal(t, discounts[1].Description, "Child rate")
		assert.Equal(t, discounts[1].MinAge, 0)
		assert.Equal(t, discounts[1].MaxAge, 17)
		assert.Equal(t, discounts[2].Code, "STUDENT")
		assert.Equal(t, discounts[2].Description, "Student rate")
		assert.Equal(t, discounts[2].MinAge, 0)
		assert.Equal(t, discounts[2].MaxAge, 0)
		assert.Equal(t, discounts[3].Code, "OAP")
		assert.Equal(t, discounts[3].Description, "Senior citizen rate")
		assert.Equal(t, discounts[3].MinAge, 65)
		assert.Equal(t, discounts[3].MaxAge, 0)
